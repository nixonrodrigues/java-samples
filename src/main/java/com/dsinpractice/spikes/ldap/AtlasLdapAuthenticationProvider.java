...
public class AtlasLdapAuthenticationProvider extends
    ...
    public Authentication authenticate(Authentication authentication)
        ...
        try {
            System.out.print(authentication.getPrincipal()+ "  authentication "+authentication.isAuthenticated());

            authentication = getLdapBindAuthentication(authentication);
            if (authentication != null && authentication.isAuthenticated()) {
                System.out.print("  authentication "+authentication.isAuthenticated());
    ...
    private Authentication getLdapAuthentication(Authentication authentication) {
        ...
        System.out.println(" AtlasLdapAuthenticationProvider getLdapAuthentication ");
