...
public class KerberosHttpClient {
    ...
    public static void main(String[] args) throws UnsupportedOperationException, IOException {
        KerberosHttpClient restTest = new KerberosHttpClient("atlas/rd-31-test-1.openstacklocal@EXAMPLE.COM",
                "/etc/security/keytabs/atlas.service.keytab", true);
        HttpResponse response = restTest.callRestUrl("http://rd-31-test-1.openstacklocal:21000/api/atlas/entities?type=hive_table",
                "atlas/rd-31-test-1.openstacklocal@EXAMPLE.COM");
